...
const StatusUpdate = ({ loading, username }) => {
    const SVG1 = (
    ...
    return (
        <ul className="max-w-md space-y-2 mt-4 text-cobbley list-inside">
            <li className="flex items-center">
                {loading == 1 ? SVG1 : SVG2}
                Validate profile: 
                <a href={`https://letterboxd.com/${username}/`} target="_blank" rel="noopener noreferrer" className="text-purpley underline hover:text-bluey">
                    { username }
                </a>
            </li>
            <li className="flex items-center">
